...
if($post['uid']==$user['id']){
  ...
  <ul class="dropdown-menu" aria-labelledby="option<?=$post['id']?>">
    <li><a class="dropdown-item" href="assets/php/actions.php?deletepost=<?=$post['id']?>"><i class="bi bi-trash-fill"></i> Gönderiyi Sil</a></li>
  </ul>
</div>
    <?php
}
...
$unlike_btn_display='';
    ...
    ?>
                ...
                &nbsp;&nbsp;<i
                        class="bi bi-chat-left d-flex align-items-center"><span class="p-1 mx-2 text-small" style="font-size:small" data-bs-toggle="modal" data-bs-target="#postview<?=$post['id']?>"><?=count($comments)?> Yorumlar</span></i> 
                        
                </h4>
                <div>
                <span class="p-1 mx-2" data-bs-toggle="modal" data-bs-target="#likes<?=$post['id']?>"><span id="likecount<?=$post['id']?>"><?=count($likes)?></span> Beğeni</span>
                <span style="font-size:small" class="text-muted">Gönderi <?=show_time($post['created_at'])?> paylaşıldı </span> 
...
<div class="d-flex align-items-center p-2">
  ...
  <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Beğeni</h5>
...
<div class="d-flex justify-content-between">
    ...
    <?php
        ...
        <div class="col-lg-4 col-sm-0 overflow-hidden mt-4 p-sm-0 p-md-3">
            ...
            <div>
                <h6 class="text-muted p-2">Onları Takip Edebilirsiniz</h6>
                <?php
...
<div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex align-items-center">
                        <button class="btn btn-sm btn-primary followbtn" data-user-id='<?=$suser['id']?>' >Takip Et</button>
...
if(count($follow_suggestions)<1){
    echo "<p class='p-2 bg-white border rounded text-center'>Önerilecek kişi yok</p>";
}
                ?>
