    ...
    <div class="login">
        <div class="col-md-4 col-sm-12 bg-white border rounded p-4 shadow-sm">
            <form>
                ...
                <h1 class="h5 mb-3 fw-normal">Merhaba, <?=$user['first_name'].' '.$user['last_name'].' ('.$user['email'].') '?> hesabınız sosyal medya kuralları dışına çıktığı için askıya alınmıştır.</h1>
